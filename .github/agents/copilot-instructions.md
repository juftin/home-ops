...
- YAML/Kubernetes manifests; Envoy Gateway v1.7+; ArgoCD; SOPS + age + `gateway.envoyproxy.io/v1alpha1` SecurityPolicy (OIDC + JWT authorization (003-envoy-gateway-oidc)
...
# Add commands for YAML/Kubernetes manifests; Envoy Gateway v1.7+; ArgoCD; SOPS + age

## Code Style

YAML manifests; Helm chart values (no compiled code): Follow standard conventions
YAML/Kubernetes manifests; Envoy Gateway v1.7+; ArgoCD; SOPS + age: Follow standard conventions
...
- 003-envoy-gateway-oidc: Added YAML/Kubernetes manifests; Envoy Gateway v1.7+; ArgoCD; SOPS + age + `gateway.envoyproxy.io/v1alpha1` SecurityPolicy (OIDC + JWT authorization
